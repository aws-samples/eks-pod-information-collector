...
# Collecting All the PODs descriptions running in User desired Namespace Or by default it will collect pods log running in default namespace
...
# # Collecting All the currently deployed kubernetes resources within the cluster.


#  -A >> "$FILENAME"
# echo "======== END OF THE FILE ==================" >> "$FILENAME"

# # Collecting All the recent events logs.
# echo "Collecting recent events log that took place within ${CLUSTERNAME}, Review file: EventsInfo.txt"
# FILENAME1="${OUTPUT_DIR}/EventsInfo.txt"
# kubectl get events -A --sort-by=.metadata.creationTimestamp > "$FILENAME1"
...
# FILENAME2="${OUTPUT_DIR}/WorkerNodeInfo.txt"
# kubectl describe node -A > "$FILENAME2"
...
# FILENAME3="${OUTPUT_DIR}/StorageInfo.txt"
# echo "[1] ===========Storage Class Details===============" > "$FILENAME3"
# kubectl get sc -A >> "$FILENAME3"
# echo "==========================" >> "$FILENAME3"
# kubectl describe sc -A >> "$FILENAME3"
# echo "==========================" >> "$FILENAME3"
# echo "[2] ===========PersistentVolume Details===============" >> "$FILENAME3"
# kubectl get pv -A >> "$FILENAME3"
# echo "==========================" >> "$FILENAME3"
# kubectl describe pv -A >> "$FILENAME3"
# echo "==========================" >> "$FILENAME3"
# echo "[3] ===========PersistentVolume Claim Details===============" >> "$FILENAME3"
# kubectl get pvc -A >> "$FILENAME3"
# echo "==========================" >> "$FILENAME3"
# kubectl describe pvc -A >> "$FILENAME3"
# echo "==========================" >> "$FILENAME3"
